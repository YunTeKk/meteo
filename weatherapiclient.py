...
class WeatherAPIClient:
    ...
    def get_coords(self, city: str) -> tuple[float, float]:
        ...
        try:
            ...
            raise ApiNetworkError("[ERREUR] Aucune réponse du serveur de l'API de géocode.") from e
    ...
    def get_meteo(self, latitude: float, longitude: float) -> dict:
        ...
        try:
            ...
            raise ApiNetworkError("[ERREUR] Aucune réponse du serveur de l'API météo.") from e